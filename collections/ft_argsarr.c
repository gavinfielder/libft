...
/*   Updated: 2019/04/30 00:59:30 by gfielder         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_argsarr		*ft_strsplit_args(char const *s, char c, char *groupers)
{
	t_argsarr		*args;
	...
	if ((args->argv = ft_strsplit_grouping(s, c, groupers)) == NULL)
